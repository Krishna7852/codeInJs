...
/**
 ...
 if its elements, from left to right, are entirely non-increasing or entirely non-decreasing.
 ...
 *
 * Hint 2:
 * Try iterating through the input array from left to right, in search of two adjacent
 * integers that can indicate whether the array is trending upward or downward.
 * Once you've found the tentative trend of the array, at each element thereafter,
 * compare the element to the previous one; if this comparison breaks the previously
 ...
 * As you iterate through each element, perform a check to see if you can invalidate one or
 * both of your assumptions.
 *
